...
@@ -12,9 +12,11 @@
   <!-- http://t.co/dKP3o1e -->
+  {% if site.resist_the_future != true %}
   <meta name="HandheldFriendly" content="True">
   <meta name="MobileOptimized" content="320">
   <meta name="viewport" content="width=device-width, initial-scale=1">
+  {% endif %}
...
--- a/_config.yml
+++ b/_config.yml
@@ -47,6 +47,9 @@ titlecase: true
+# When set to true, we won't include meta tags that optimize for mobile.
+resist_the_future: true
+
```
